...
@AutoConfiguration
@ConditionalOnWebApplication(type = SERVLET)  //当Spring为web服务时，才使注解的类生效；通常是配置类；
public class WebMvcConfiguration implements WebMvcConfigurer {
    /**
     * 增加GET请求参数中时间类型转换 {@link com.learn.common.core.jackson.PigJavaTimeModule}
     * <ul>
